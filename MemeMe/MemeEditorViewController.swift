...
//    @IBOutlet var shareButton: UIBarButtonItem!
    ...
    func generateMemedImage() -> Meme {
        ...
        let memedImageObject = Meme(top: topTextField.text!, bottom: bottomTextField.text!, image: imagePickerView.image ?? UIImage(), memedImage: UIGraphicsGetImageFromCurrentImageContext()!)
